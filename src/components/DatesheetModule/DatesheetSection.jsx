  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        <div className="flex flex-1 p-1 bg-slate-100 rounded-full border border-slate-200/80">
          <button
        ...
        {onNavigateMarksheets && (
          <button
            ...
            className="px-3.5 py-2 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 text-xs font-bold flex items-center gap-1.5 transition-colors shrink-0 cursor-pointer shadow-2xs"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="px-2 py-0.5 rounded-full bg-slate-100 text-slate-600 font-mono text-[9px] font-semibold border border-slate-200 shrink-0">
                        {t.id}
                      </span>
                    </div>
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3.5 py-1.5 rounded-full bg-[#111827] hover:bg-black text-white text-xs font-semibold transition-colors shrink-0 cursor-pointer"
                  >
                    <Eye className="w-3 h-3 text-white" />
                    <span>View</span>
                  </button>
