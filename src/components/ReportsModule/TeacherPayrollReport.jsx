    ...
    <div className="space-y-4 pb-24 animate-in fade-in duration-200 w-full min-w-0 overflow-x-hidden p-3.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="bg-white p-4 rounded-3xl border border-[#E5E7EB] shadow-[0_4px_24px_-2px_rgba(17,24,39,0.04)]">
          <span className="text-[10px] text-[#575E70] font-bold uppercase tracking-wider block">Total Monthly Budget</span>
        ...
        <div className="bg-white p-4 rounded-3xl border border-teal-200/80 bg-teal-50/20 shadow-[0_4px_24px_-2px_rgba(17,24,39,0.04)]">
          <span className="text-[10px] text-teal-700 font-bold uppercase tracking-wider block">Disbursed Salaries</span>
          <p className="text-xl sm:text-2xl font-bold text-teal-700 mt-1 font-display">
            Rs. {payrollData.totalDisbursed.toLocaleString()}
          </p>
          <span className="text-[11px] text-teal-600 font-medium mt-0.5 block flex items-center gap-1">
      ...
      {/* Search Bar */}
      <div className="bg-white p-4 rounded-3xl border border-[#E5E7EB] shadow-[0_4px_24px_-2px_rgba(17,24,39,0.04)] flex items-center justify-between gap-3">
          ...
          <table className="w-full text-xs text-left min-w-[500px]">
            ...
            <tbody className="divide-y divide-[#F3F4F6] font-medium">
              {filteredList.length === 0 ? (
                ...
                filteredList.map(t => (
                  <tr key={t.id} className="hover:bg-[#F8F9FB]/80 transition-colors">
