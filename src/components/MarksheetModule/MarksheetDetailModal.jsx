  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-3 bg-black/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl flex flex-col max-h-[94vh] overflow-hidden border border-slate-100">
        ...
        <div className="px-5 py-4 bg-gradient-to-r from-amber-600 via-amber-500 to-indigo-700 text-white flex items-center justify-between shrink-0 shadow-sm">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            {!readOnly && onEdit && (
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-white/20 hover:bg-white/30 text-white text-xs font-bold flex items-center gap-1.5 transition-colors border border-white/20"
        ...
        <div className="p-4 space-y-4 overflow-y-auto flex-1 bg-slate-50/50">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center">
            ...
            <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-xs">
              ...
              <span className="text-xs font-black text-emerald-700 truncate block" title={topper?.studentName}>
          ...
          <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-xs flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-900 text-xs font-bold flex items-center gap-1.5 transition-colors border border-amber-200/80"
              >
                {copiedClassSummary ? (
                  <>
              ...
              return (
                <div
                  ...
                  className={`bg-white rounded-2xl border p-3.5 shadow-xs space-y-3 transition-all ${
                    isTop3 ? 'border-amber-200/90 shadow-sm' : 'border-slate-200/80'
                  }`}
                >
                  ...
                  <div className="flex items-center justify-between gap-2 border-b border-slate-100 pb-2.5">
                    <div className="flex items-center gap-2.5 min-w-0">
                      <span
                        className={`w-7 h-7 rounded-xl text-xs font-black flex items-center justify-center shrink-0 border ${rankBadge.bg}`}
                      >
                        {rankBadge.label}
                      </span>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-700 transition-colors border border-emerald-200 shrink-0"
            ...
            <div className="p-4 rounded-2xl bg-rose-50 border border-rose-200 space-y-2.5 animate-in fade-in">
              ...
              <div className="flex justify-end gap-2 pt-1">
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-white border border-slate-200 text-slate-700 text-xs font-bold hover:bg-slate-50 transition-colors"
                >
                  Cancel
                </button>
                <button
