    ...
    <div className="flex flex-col flex-1">
      ...
      {!studentOnly && (
        <div className="bg-white px-4 pt-3 pb-2 border-b border-slate-100">
          <div className="grid grid-cols-2 gap-1 bg-slate-100 p-1 rounded-full text-xs font-bold">
            <button
              type="button"
              onClick={() => setAttendanceType('students')}
              className={`py-1.5 px-3 rounded-full flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
