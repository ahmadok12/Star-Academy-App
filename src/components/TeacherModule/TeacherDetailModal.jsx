      ...
      >
        ...
        <div className="relative bg-gradient-to-br from-indigo-700 via-indigo-600 to-brand-800 text-white p-5 pt-4">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 bg-amber-400 hover:bg-amber-300 text-slate-900 px-3 py-1.5 rounded-xl text-xs font-bold shadow-sm transition-all tap-active cursor-pointer"
              >
              ...
              <button
                onClick={onClose}
                className="w-8 h-8 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm flex items-center justify-center text-white transition-colors cursor-pointer"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-indigo-100 font-medium mt-0.5 flex items-center gap-1">
            ...
            {teacher.assignedClasses && teacher.assignedClasses.length > 0 ? (
              <div className="flex flex-wrap gap-1.5">
                {teacher.assignedClasses.map((item, idx) => (
                  <span
                    key={idx}
                    className="px-2.5 py-1 rounded-lg bg-indigo-50 border border-indigo-200/80 text-indigo-800 font-semibold text-[11px]"
                  >
                    {item}
                  </span>
                ))}
        ...
        <div className="p-3.5 border-t border-slate-200 bg-white flex items-center gap-2">
          ...
          <button
            ...
            className={`flex-1 py-2.5 px-3 rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 transition-all tap-active cursor-pointer ${
              confirmDelete
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex-1 py-2.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-900 text-white font-bold text-xs transition-colors tap-active cursor-pointer"
          >
            Close Details
          </button>
        </div>
