  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between text-xs text-slate-500 font-medium px-1">
        ...
        <span>Total Reserves: <strong className="text-slate-900 font-bold">Rs. {totalLiveLiquidity.toLocaleString()}</strong></span>
      </div>
              ...
              >
                ...
                <div className="text-right shrink-0 flex flex-col items-end gap-1.5">
                  ...
                  <button
                    ...
                    className="rounded-full bg-[#111827] hover:bg-black text-white text-xs font-semibold px-3.5 py-1.5 flex items-center gap-1 transition-all cursor-pointer"
                  >
