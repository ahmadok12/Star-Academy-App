  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between text-xs text-slate-500 font-medium px-1">
        ...
        <span>Total Rebalanced: <strong className="text-slate-900 font-bold">Rs. {totalTransferred.toLocaleString()}</strong></span>
      </div>
        ...
        {filteredTransfers.length === 0 ? (
          ...
          filteredTransfers.map((trf) => {
            ...
            return (
              <div
                key={trf.id}
                className="p-3.5 bg-white rounded-2xl border border-slate-200/80 shadow-xs hover:border-slate-300 transition-all space-y-2"
              >
                ...
                <div className="flex items-center justify-between gap-2 p-2 bg-slate-50 rounded-xl text-[11px]">
                  <div className="truncate flex-1">
                    <span className="text-[9px] text-slate-500 font-bold block">FROM</span>
                  ...
                  <div className="truncate flex-1 text-right">
                    <span className="text-[9px] text-slate-500 font-bold block">TO</span>
                    <span className="font-bold text-slate-800 truncate block">
