        ...
        <div className="bg-[#111827] p-5 text-white flex items-center justify-between border-b border-slate-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 font-mono font-medium">{bank.id}</p>
            </div>
          </div>
        ...
        <div className="p-5 overflow-y-auto space-y-4 text-xs">
          ...
          <div className="space-y-2.5 bg-slate-50 p-4 rounded-2xl border border-slate-100">
            ...
            <div className="flex items-start justify-between py-1 border-b border-slate-200/60">
              ...
              <span className="font-bold text-slate-900 text-right">Rs. {Number(bank.openingBalance).toLocaleString()}</span>
            </div>
