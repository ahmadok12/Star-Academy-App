      ...
      <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden border border-[#E5E7EB] flex flex-col max-h-[90vh]">
        ...
        <div className="bg-[#111827] px-6 py-4 text-white flex items-center justify-between border-b border-white/10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-white font-display tracking-tight leading-tight">Fee Voucher Details</h2>
              <p className="text-[11px] text-slate-400 font-mono font-medium">{voucher.id}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/15 text-white text-xs font-semibold transition-colors cursor-pointer"
            >
          ...
          <div className="space-y-2 pt-1">
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="py-2.5 px-3 rounded-full bg-[#111827] hover:bg-black text-white font-semibold text-xs flex items-center justify-center gap-1.5 shadow-xs transition-all tap-active cursor-pointer"
              >
              ...
              <button
                ...
                className="py-2.5 px-3 rounded-full bg-white hover:bg-[#F3F4F6] text-slate-800 font-semibold text-xs border border-[#E5E7EB] flex items-center justify-center gap-1.5 shadow-2xs transition-all tap-active cursor-pointer"
              >
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs flex items-center justify-center gap-2 shadow-sm transition-all tap-active cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full py-2 px-4 rounded-full bg-white hover:bg-[#F3F4F6] text-slate-700 font-semibold text-xs border border-[#E5E7EB] flex items-center justify-center gap-2 transition-colors tap-active cursor-pointer shadow-2xs"
            >
        ...
        <div className="p-4 bg-[#F8F9FB] border-t border-[#E5E7EB]">
          {confirmDelete ? (
            <div className="p-3 bg-rose-50 border border-rose-200 rounded-2xl space-y-2">
              ...
              <div className="flex gap-2 pt-1">
                <button
                  ...
                  className="flex-1 py-2 px-3 rounded-full border border-slate-200 bg-white text-slate-700 font-semibold text-xs cursor-pointer hover:bg-slate-50"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-2 px-3 rounded-full bg-rose-600 text-white font-semibold text-xs shadow-xs hover:bg-rose-700 cursor-pointer"
                >
                  Confirm Delete
                </button>
              </div>
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-full border border-rose-200 bg-rose-50/60 hover:bg-rose-100/70 text-rose-700 font-semibold text-xs flex items-center justify-center gap-2 transition-colors cursor-pointer"
            >
