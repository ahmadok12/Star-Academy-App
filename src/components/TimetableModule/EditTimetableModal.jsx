      ...
      <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden border border-slate-100 flex flex-col max-h-[92vh]">
        ...
        <div className="bg-gradient-to-r from-teal-600 to-emerald-700 p-5 text-white flex items-center justify-between shadow-md">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-black tracking-tight leading-tight">Edit Timetable</h2>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1.5 rounded-xl bg-teal-50 hover:bg-teal-100 text-teal-800 text-[11px] font-bold"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1.5 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-800 text-[11px] font-bold"
                >
                ...
                return (
                  <div
                    ...
                    className={`p-3 rounded-2xl border ${
                      isBreak ? 'bg-amber-50/60 border-amber-200' : 'bg-slate-50 border-slate-200'
                    }`}
                  >
                    <div className="flex items-center justify-between gap-2 mb-2">
                      <div className="flex items-center gap-1.5">
                        ...
                        <input
                          ...
                          className="text-xs font-bold text-slate-900 bg-white px-2 py-1 rounded-lg border border-slate-300 outline-none w-48"
                        />
                      </div>
